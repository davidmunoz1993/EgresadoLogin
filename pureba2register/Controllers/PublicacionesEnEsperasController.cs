...
namespace pureba2register.Controllers
{
    public class PublicacionesEnEsperasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PublicacionEnEspera,FechaInicio,FechaFinalizacion,Asunto,Informacion")] PublicacionesEnEspera publicacionesEnEspera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PublicacionEnEspera,FechaInicio,FechaFinalizacion,Asunto,Informacion")] PublicacionesEnEspera publicacionesEnEspera)
        {
            if (ModelState.IsValid)
            {
